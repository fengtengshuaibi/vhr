<template>
  <div>
    <div>
      <div style="display: flex;justify-content: space-between">
        <div>
          ...
          <el-button icon="el-icon-search" type="primary" @click="initScores">
            搜索
          </el-button>
        </div>
        <div>
    ...
    <div style="margin-top: 10px">
      <el-table :data="scores" border v-loading="loading" element-loading-text="正在加载..." element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)" style="width: 100%" height="calc(100vh - 160px)">
        ...
        <el-table-column prop="quarter1" label="第一季度" width="100" sortable></el-table-column>
        <el-table-column prop="quarter2" label="第二季度" width="100" sortable></el-table-column>
        <el-table-column prop="quarter3" label="第三季度" width="100" sortable></el-table-column>
        <el-table-column prop="quarter4" label="第四季度" width="100" sortable></el-table-column>
...
export default {
    ...
    methods: {
        ...
        initScores() {
            this.loading = true;
            let url = '/statistics/executive/?page=' + this.page + '&size=' + this.size;
        ...
        exportData() {
            window.open('/statistics/executive/export?empName=' + this.keyword + '&year=' + (this.year||'') + (this.dateScope ? '&beginDate=' + this.dateScope[0] + '&endDate=' + this.dateScope[1] : ''), '_parent');
        },
